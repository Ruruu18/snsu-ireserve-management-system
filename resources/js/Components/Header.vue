...
<template>
    <nav class="border-b border-gray-200 bg-gradient-to-r from-[#d6efd8] to-[#c8e6ca] shadow-sm">
        <div class="px-4 sm:px-6 lg:px-8">
            <div class="flex h-16 sm:h-20 justify-between items-center">
                <div class="flex items-center">
                    ...
                    >
                        ...
                        <svg :class="showMobileMenu ? 'hidden' : 'block'" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6h16M4 12h16M4 18h16" />
                        </svg>
                        <svg :class="showMobileMenu ? 'block' : 'hidden'" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
            ...
            <!-- Mobile menu panel -->
            <div :class="showMobileMenu ? 'block' : 'hidden'" class="md:hidden" id="mobile-menu">
