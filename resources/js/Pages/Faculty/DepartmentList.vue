...
const createDepartment = () => {
    createForm.post(route('faculty.departments.store'), {
        onSuccess: () => {
            closeModals();
            createForm.reset();
        },
...
const updateDepartment = () => {
    editForm.put(route('faculty.departments.update', selectedDepartment.value.id), {
        onSuccess: () => {
            closeModals();
        },
    });
...
const deleteDepartment = () => {
    deleteForm.delete(route('faculty.departments.destroy', selectedDepartment.value.id), {
        onSuccess: () => {
            closeModals();
        },
    });
...
const searchDepartments = () => {
    router.get(route('faculty.departments.index'), {
