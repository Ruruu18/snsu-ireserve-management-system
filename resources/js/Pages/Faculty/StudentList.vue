...
const createStudent = () => {
    createForm.post(route('faculty.students.store'), {
        onSuccess: () => {
            closeModals();
            createForm.reset();
        },
...
const updateStudent = () => {
    editForm.put(route('faculty.students.update', selectedStudent.value.id), {
        onSuccess: () => {
            closeModals();
        },
    });
...
const deleteStudent = () => {
    deleteForm.delete(route('faculty.students.destroy', selectedStudent.value.id), {
        onSuccess: () => {
            closeModals();
        },
    });
