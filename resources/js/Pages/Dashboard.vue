...
// Navigate to admin issue equipment page when clicking on a reservation
const viewReservationDetails = (reservation) => {
    // Navigate to admin issue equipment page where this reservation can be managed
    router.visit(route('admin.issue-equipment'));
};
</script>
